...
before i conclude for today i also just want to finish with some advice & tips

in terms of supervision, dont panic, its gonna be ok, you'll be ok, we'll all be ok, we'll get through it, and it'll be good

students know what theyre doing, they just dont know that, they won't tell u this, and they dont feel like this, but we've really held their hand throughout their stats learning, which in one sense hasnt been the most helpful in terms of their own independence, but in their last stats module we stopped that, we left a lot of it up to them, we forced them to make their own analytical decisions with their lab report and they had to get involved and actually think about what they needed to do rather than being told, and it really surprised me how well they did and how positively they ended up feeling about it, they didnt like it originally, but so many ive spoken to since have told me they really liked that assignment and felt like they learnt the most & it was a really quite complex analysis & the code involved was a lot

they'll most likely tell u theyre really anxious about their dissertation around using R and their analyses, but it isnt as specific to R as they think it is & how it might sound to you, a large part of it will just be because dissertations feel scary no one feels like they know what theyre doing for the most part, as im sure u all know, a lil reassurance goes a long way

they have access to everything that they need on canvas, its just a case of them actually going to find it and revising it briefly to know how to apply it to their own data, as part of the research disseration module they'll also have access to an R Helpdesk, and two analyses workshops ao its all gonna be fine



in terms of your own learning, r can be tricky, it can feel very weird to begin with, everything seems really unfamiliar so thats why you should try to use it as often as you can, even if its just for a few minutes, it is a language after all, and its easy to forget stuff if you leave it a while
...
i'm not preparing anything too far in advance because i want to be responsive to any issues ur having, so do let me know if anything just doenst make sense

that's all from me for today, thank u all for getting involved in the course, i hope that ul find it helpful, in a moment, for those of you that dont have r and rstudio installed yet, i'll show you where u can download them, but otherwise we are at the end of the session now, does anyone have any questions? if not ur free to leave and u can go start on the tutorial for this week

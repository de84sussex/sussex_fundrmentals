...
At Sussex, your dissertation should be submitted with the file name: **cand_no_report**

When creating the Rmd for your dissertation write-up, save it with this file name from the start to avoid any issues later on & remember to save it in the **r_docs** folder of your R Project as suggested in the [workflow](#workflow)
...
To avoid errors & to check your word-count/spelling more accurately, I recommend knitting to a Word doc
...
Move this file to the **references** folder of your R Project to keep with the [workflow](#workflow) 
...
Search for a relevant article & copy/paste the entry to your **.bib** file (you can open the **.bib** file in RStudio by clicking on it in the **Files** pane)
...
You can now start writing up your dissertation in RMarkdown woohoo! `r emo::ji("woman_dancing")``r emo::ji("partying_face")`
...
- Don't ever install packages in your code chunks - use the console
